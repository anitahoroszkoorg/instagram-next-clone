...
export const messages: Message[] = [
  ...
  { id: 4, text: "Thank you so much!", sender: "David", read: false },
  { id: 5, text: "next saturday at 4pm", sender: "Eva", read: true },
  {
    id: 6,
    text: "nice",
    sender: "Fiona",
  ...
  { id: 10, text: "did you make any plans?", sender: "Homer", read: true },
  { id: 11, text: "heyyy", sender: "Lisa", read: true },
  { id: 12, text: "how was the birthday?", sender: "Maria", read: true },
  { id: 13, text: "in the other groupchat", sender: "Guy", read: true },
  {
    id: 14,
    text: "did you get my invite yet",
    sender: "Richard",
    read: true,
  },
];
